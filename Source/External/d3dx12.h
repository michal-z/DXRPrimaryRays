...
private:
    ...
    eastl::list<SUBOBJECT_WRAPPER>   m_SubobjectList; // Pointers to list nodes handed out so 
                                                    // these can be edited live
    eastl::vector<D3D12_STATE_SUBOBJECT> m_SubobjectArray; // Built at the end, copying list contents

    eastl::list<D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION> 
    ...
    private:
        eastl::list<eastl::wstring> m_Strings;
    };
    ...
    eastl::list<eastl::unique_ptr<const SUBOBJECT_HELPER_BASE>> m_OwnedSubobjectHelpers;
#else
    class OWNED_HELPER
    {
    public:
    ...
    eastl::list<OWNED_HELPER> m_OwnedSubobjectHelpers;
#endif
...
private:
    ...
    eastl::vector<D3D12_EXPORT_DESC> m_Exports;
};
...
private:
    ...
    CD3DX12_STATE_OBJECT_DESC::StringContainer m_Strings;
    eastl::vector<LPCWSTR> m_Exports;
};
